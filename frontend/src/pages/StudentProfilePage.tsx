...
import {
  ...
  type FeeLedger,
  fmtHumanDate,
} from '../components/fees/FeeLedgerModal';
...
// ─── Fee Ledger types (imported from shared FeeLedgerModal component) ────────
// LedgerEntryType, FeeLedgerEntry, FeeLedger, LEDGER_TYPE_CONFIG are imported above.
...
// fmtHumanDate is imported from FeeLedgerModal shared component above.
...
function FeesTab({ studentId, studentName }: { studentId: number; studentName: string }) {
  ...
  return (
    <div style={{ display: 'grid', gap: 14 }}>
      ...
      {/* ─── Fee Ledger ────────────────────────────────────────────────────── */}
      <Card style={{ padding: 0, overflow: 'hidden' }}>
        <div style={{ padding: '12px 16px 10px', borderBottom: '1px solid rgba(15,23,42,0.07)', fontWeight: 700, fontSize: 13 }}>
          Fee Ledger
        </div>
        <FeeLedgerView
